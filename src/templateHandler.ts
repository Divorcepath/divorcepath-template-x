...
export class TemplateHandler {
    ...
    constructor(options?: TemplateHandlerOptions) {
        ...
        this.compiler = new TemplateCompiler(
            ...
            this.options.plugins,
            {
                ...
                tableContainerContentType:
                    this.options.tableContainerContentType,
    ...
    public async process<T extends Binary>(
        ...
        for (const part of contentParts) {
            ...
            await this.callExtensions(
                this.options.extensions?.beforeCompilation,
                scopeData,
                context
            );
            ...
            await this.callExtensions(
                this.options.extensions?.afterCompilation,
                scopeData,
                context
            );
        }
    ...
    public async parseTags(
        templateFile: Binary,
        contentPart = ContentPartType.MainDocument
    ): Promise<Tag[]> {
        const docx = await this.loadDocx(templateFile);
